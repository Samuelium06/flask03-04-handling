...
@app.route("/")
def home():
    return 'This is home page for no path, <h1> Welcome Home sincerly from Samuel</h1>' 
...
@app.route('/about')
def about():
    return '<h1>This is SAMUEL about page </h1>'
...
@app.route('/error')
def error():
    return '<h1>Either you encountered an error or you are not authorized. get the fuck out of here </h1>'
...
def greet_admin():
    return redirect(url_for('greet', name='Master Samuel!!!!'))
